...
% PSD_21 = open('2015-07-29-002_LFP_PSD_h1.fig');    
% PSD_21_ax = get(gcf, 'children');
% 
% PSD_22 = open('2015-07-29-002_LFP_PSD_h6.fig');    
...
set(gcf,'PaperUnits','centimeters','PaperPosition',[1.2 1.2 21 14]); %[left, bottom, width, height] 
set(gcf,'PaperOrientation','portrait');
set(gcf,'Units','centimeters','Position',get(gcf,'paperPosition')+[0 0 0 0]);


%% Positions:
traces_11_pos(1,:) = [0.05 , 0.5 , 0.58 , 0.3];
traces_12_pos(1,:) = [0.05 , 0.6 , traces_11_pos(1,3) , traces_11_pos(1,4)]; traces_12_pos(1,2)=traces_11_pos(1,2)-traces_11_pos(1,4)-0.1;
...
%   annotation:
annotation('textbox', [traces_11_pos(1,1) traces_11_pos_top 0 0]+[0.17 0.07 0.8 0.05],...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'Barrel cortex LFP with GABAa antagonist', 'FontName','arial', 'fontsize', 14, 'fontweight', 'bold')
...
%  
 ...
 a_pos3=[0.5*traces_11_pos(1,3)-0.02, 0.02, 0.5, 0.05];
...
annotation('textbox', [traces_12_pos(1,1) traces_12_pos_top 0 0]+a_pos5,...
     'FitHeightToText', 'on', 'edgecolor', 'none','string', 'Picrotoxin', 'FontName','arial', 'fontsize', 12, 'fontweight', 'bold')
...
filename='Fig 1c LFP traces+PSD_1-100Hz+GABA Blockers';
saveas(F,'Fig 1c LFP traces+PSD_1-100Hz+GABA Blockers.fig'); 
