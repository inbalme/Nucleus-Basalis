...
spont_cc_On_f46_pos(1,:) = [0.12 , spont_trace_On_f46_pos(1,2)-spont_trace_On_f46_pos(1,4) , 0.25 , 0.1];
spont_cc_Off_f46_pos(1,:) = [0.12 , 0.5 , 0.25 , 0.1]; spont_cc_Off_f46_pos(1,2)=spont_cc_On_f46_pos(1,2)-spont_cc_Off_f46_pos(1,4)-0.06;
...
cc_paired_plot_shuff_pos(1,:) = [spont_cc_Off_f46_pos(1,1) , 0.04 , 0.22 , 0.17];
cc_paired_plot_shuff_pos_top = cc_paired_plot_shuff_pos(1,2)+cc_paired_plot_shuff_pos(1,4);
cc_paired_plot_pos(1,:) = [h_dist2 , 0.04 , 0.22 , 0.17];  
...
set(evoked_cc_On_f46_ax_copy(2),'position',evoked_cc_On_f46_pos(1,:),'xticklabel',[])
   ...
   %position legend
 set(evoked_cc_On_f46_ax_copy(1),'position',[0.86 evoked_cc_On_f46_pos_top-0.03 0.08 0.05]) 
